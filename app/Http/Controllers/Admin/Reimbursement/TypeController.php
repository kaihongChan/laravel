...
class TypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $instance = new ReimbursementType($requestData);
        if (!$instance->save()) {
            return response()->json([
                'message' => '资源创建失败！'
            ], Response::HTTP_BAD_REQUEST);
    ...
    {
        $resource = ReimbursementType::query()->findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!ReimbursementType::query()->findOrFail($id)->update($requestData)) {
            return response()->json([
                'message' => '资源更新失败！'
            ], Response::HTTP_BAD_REQUEST);
        }
    ...
    {
        if (!ReimbursementType::destroy($id)) {
            return response()->json([
                'message' => '资源删除失败！'
            ], Response::HTTP_BAD_REQUEST);
        }
    ...
    public function all()
    {
        $list = ReimbursementType::all(['id', 'name']);
